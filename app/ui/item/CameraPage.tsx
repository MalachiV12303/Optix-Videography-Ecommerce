        ...
        <section className="h-[calc(100vh-5rem)] sm:h-[calc(100vh-6rem)] flex flex-col md:flex-row md:items-center">
            ...
            <div className="bg-background flex flex-col p-4 border-1 border-foreground w-full md:w-[50%] lg:w-[40%]">
                ...
                <div className="flex flex-col gap-2 text-nowrap w-full items-center md:items-start">
                    <span className="text-2xl font-semibold text-wrap">{cam.brand} {cam.name} {cam.type === "DSLR" ? "Digital Camera" : "Mirrorless Camera"}</span>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="py-2 px-4 text-sm text-wrap"><span>{cam.description}</span></div>
                        <span className="font-bold px-4 py-2 text-lg border-b-1 border-foreground">details</span>
                        <div className="py-2 px-4 text-wrap">
                            <span><span className="font-semibold">shutter speed: </span>{cam.shutter}</span>
                            <br />
                            <span><span className="font-semibold">resolution: </span>{cam.res}p</span>
                        </div>
                        ...
                        <div className="py-2 px-4 text-sm text-wrap">
                            <div className='flex flex-wrap gap-2'><span className="font-semibold">storage: </span>{cam.storage?.map((sdtype, index) => (<span key={index}>{sdtype}</span>))}</div>
                            <div className='flex gap-2'><span className="font-semibold">mount type: </span>{cam.mount?.map((lentype, index) => {
